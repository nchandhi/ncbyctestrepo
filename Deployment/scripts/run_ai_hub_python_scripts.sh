...
requirementFileUrl=${baseUrl}"Deployment/scripts/ai_hub_python_scripts/requirements.txt"

echo "Download Started"

# Download the create_index python files
curl --output "create_ai_hub.py" ${baseUrl}"Deployment/scripts/ai_hub_python_scripts/create_ai_hub.py"
