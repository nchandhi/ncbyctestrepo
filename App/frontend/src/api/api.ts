import { UserInfo, ConversationRequest, Conversation, ChatMessage, CosmosDBHealth, CosmosDBStatus, DocumentSection } from "./models";
...
export const getArticleDetails = async (articleId: string): Promise<Response | null> => {
