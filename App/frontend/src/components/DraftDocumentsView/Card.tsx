...
import { 
  ...
  DialogSurface,
  DialogTitle,
  DialogBody, Card as FluentCard, CardHeader, CardProps as FluentCardProps } from '@fluentui/react-components'
        ...
        <Dialog
          ...
          onOpenChange={async (event, data) => {
            ...
            for (let i = 0; i < newDocumentSections.length; i++) {
              ...
              documentSections[i].metaPrompt = `Create ${documentSections[i].title} of research grant application for - ${appStateContext?.state.researchTopic}. Structure the content into logical paragraphs.`
            }
